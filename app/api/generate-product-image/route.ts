...
CRITICAL RULE:
Uploaded image is the ONLY product.

DO NOT change product shape, color, or brand.
...
export async function POST(req: NextRequest) {
  try {
    ...
    const avatarPrompt = avatar
      ? `
A realistic human model is in the scene.
Reference face image:
${avatar}

The model stands beside the product.
